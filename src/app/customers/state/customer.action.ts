...
/**
 * Implementation without the concept of entity in implemented below.
 * Implementation with the concept of entity is there after these commented lines.
 */
/*
...
/**
 * Implementation with the help of entity.
 */
export enum CustomerActionTypes {
    LOAD_CUSTOMERS = "[Customer] Load Customers",
    LOAD_CUSTOMERS_SUCCESS = "[Customer] Load Customers Success",
